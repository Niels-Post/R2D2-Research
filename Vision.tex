...
\begin{document}
    ...
    \begin{titlepage}
        \centering
        \maketitle
        \includegraphics[height=0.6\textheight]{vision.jpg}
        \clearpage
    \end{titlepage}
    ...
    \begin{enumerate}
        ...
        \item \label{itm:dv4} Wat is de beste camera voor het toepassen van Vision algoritmes die verkrijgbaar is op de markt?
        \item \label{itm:dv5} Volgt er een toename in accuraatheid uit het langer analyseren van een frame?
...
%    \end{tabular}
    ...
    \paragraph{Geschatte piek-geheugengebruik per meting}
    Gezien de ondergrens 3 frames is voor enige nauwkurigheid zijn de geheugen eisen voor het bewaren van de frames niet groot. Echter is een optical flow model wel een flinke
