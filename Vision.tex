...
\begin{document}
    ...
    Tijdens het vergelijken van de twee algoritmen zijn we bij allebei de implementaties tegen problemen aangelopen.
    Hierdoor kunnen wij geen accurate conclusie trekken over het geschiktere algoritme.
